...
import org.amnezia.leninvpn.protocol.ProtocolState.CONNECTING
import org.amnezia.leninvpn.protocol.ProtocolState.DISCONNECTED
import org.amnezia.leninvpn.protocol.ProtocolState.DISCONNECTING
import org.amnezia.leninvpn.protocol.ProtocolState.RECONNECTING
import org.amnezia.leninvpn.protocol.ProtocolState.UNKNOWN
import org.amnezia.leninvpn.protocol.VpnException
import org.amnezia.leninvpn.protocol.VpnStartException
import org.amnezia.leninvpn.protocol.putStatus
import org.amnezia.leninvpn.util.LoadLibraryException
import org.amnezia.leninvpn.util.Log
import org.amnezia.leninvpn.util.Prefs
import org.amnezia.leninvpn.util.net.NetworkState
import org.amnezia.leninvpn.util.net.TrafficStats
import org.json.JSONException
import org.json.JSONObject

private const val TAG = "LeninVpnService"

const val ACTION_DISCONNECT = "org.amnezia.LeninVPN.action.disconnect"
const val ACTION_CONNECT = "org.amnezia.LeninVPN.action.connect"
...
open class LeninVpnService : VpnService() {
                        ...
                        clientMessengers[msg.replyTo]?.let { clientMessenger ->
                            clientMessenger.send {
                                ServiceEvent.STATUS.packToMessage {
                                    putStatus(this@LeninVpnService.protocolState.value)
                                }
                            }
                        }
                    }
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "Create LeninVPN service")
