...
namespace
{
    ...
    constexpr auto QT_ANDROID_CONTROLLER_CLASS = "org/leninvpn/leninvpn/qt/QtAndroidController";
    constexpr auto ANDROID_LOG_CLASS = "org/leninvpn/leninvpn/util/Log";
